...
public class ZZapLobbyManager : MonoBehaviour, INetworkRunnerCallbacks
{
    [Header("UI 패널입니다")]
    ...
    public async void OnClick_ConfirmCreateRoom()
    {
        ...
        if (result.Ok)
        {
            ...
            // 방장만 게임 씬을 로드 
            _runner.LoadScene(SceneRef.FromIndex(SceneUtility.GetBuildIndexByScenePath("Assets/Resources/Scenes/Min/1StageCopy.unity")));
        }
        else
        {
