...
public static class TutorialGameInputLock               // 플레이어 움직임 잠금
{
...
public class TutorialSpannerMiniGame : MonoBehaviour
{
    ...
    public GameObject targetValve;
    public TutotialSpanner ownerSpanner;         // 사운드 전용
